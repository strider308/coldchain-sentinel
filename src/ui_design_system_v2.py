...
@media(prefers-reduced-motion:reduce){body.ui-v2 *,body.ui-v2 *::before,body.ui-v2 *::after{scroll-behavior:auto!important;animation-duration:.01ms!important;animation-iteration-count:1!important;transition-duration:.01ms!important}}
</style>
"""

SKIP_LINK = '<a class="ui-skip" href="#main-content">Skip to content</a>'
GLOBAL_NAV = SKIP_LINK + '<nav class="ui-global-nav" aria-label="Primary"><a href="/">Home</a><a href="/command-center">Command Center</a><a href="/case-walkthroughs/door-open-warming">Start Demo</a><a href="/judge-pack">Evidence</a><a href="/submission-readiness">Submission</a></nav>'
...
def apply_design_system(page: str) -> str:
    ...
    if 'class="ui-global-nav"' not in page:
        navigation = SKIP_LINK if 'class="global-nav"' in page else GLOBAL_NAV
        page = page.replace('data-ui-version="coherent-fast-v1">', 'data-ui-version="coherent-fast-v1">' + navigation, 1)
